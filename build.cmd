...
cl /nologo /std:c++17 /EHsc /W4 /utf-8 /DUNICODE /D_UNICODE /O2 src\proto.cpp src\sensing_hotkey.cpp src\fgutil.cpp src\inject.cpp src\carrier.cpp /link user32.lib gdi32.lib dwmapi.lib /out:proto.exe
if errorlevel 1 (
